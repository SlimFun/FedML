...
class Resnet56(nn.Module):
    ...
    def __init__(self, class_num, neck, pretrained=False, num_features=0, neck_feat='after', path=None, **kwargs):
    ...
    def forward(self, x):
        ...
        global_feat = self.avgpool(output_feat)
#         global_feat = self.avgpool(self.base(x))  # (b, 256, 1, 1)
...
# def resnet56(class_num, pretrained=False, neck, num_features=0, path=None, **kwargs):
#     """
...
#     """
#     resnet = ResNet(Bottleneck, [6, 6, 6], class_num, **kwargs)
