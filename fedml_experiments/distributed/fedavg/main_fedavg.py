...
from fedml_api.model.cv.resnet_b import ResNet50, ResNet18
...
def add_args(parser):
    ...
    parser.add_argument('--freq_of_the_sync_stats', type=int, default=2,
                        help='the frequency of the algorithms sync statistics')
